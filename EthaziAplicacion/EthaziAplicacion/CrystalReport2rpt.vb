...
Public Class CrystalReport2rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EthaziAplicacion.CrystalReport2rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport2rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport2rpt = New CrystalReport2rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
